...
public class MoneyOutAdapter extends BaseAdapter{
    private static LayoutInflater inflater = null;
    private Fragment activity;
    MyViewHolder holder = null;
    ArrayList<AllTransactions> getTransactionsMoneyOut;

    public MoneyOutAdapter(Fragment a, ArrayList<AllTransactions> transactionsArrayList) {
        getTransactionsMoneyOut=transactionsArrayList;
        activity=a;
    ...
    @Override
    public int getCount() {
        return getTransactionsMoneyOut.size();
    }

    @Override
    public AllTransactions getItem(int position) {
        return getTransactionsMoneyOut.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {
            convertView = inflater.inflate(R.layout.row_list_money_out, null);
        ...
        AllTransactions tu= getTransactionsMoneyOut.get(position);
